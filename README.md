# go-clang/v3.6 [![GoDoc](https://godoc.org/github.com/go-clang/v3.6?status.png)](https://godoc.org/github.com/go-clang/v3.6) [![Build Status](https://travis-ci.org/go-clang/v3.6.svg?branch=master)](https://travis-ci.org/go-clang/v3.6)
...
CGO_LDFLAGS="-L`llvm-config --libdir`" \
  go get -u github.com/go-clang/v3.6/...
```
